...
public class GreenPaintballEntity extends PersistentProjectileEntity {


    public GreenPaintballEntity(EntityType<? extends PersistentProjectileEntity> type, World world) {
        super(type, world, ItemStack.EMPTY);
    }

    public GreenPaintballEntity(LivingEntity owner, World world) {
        super(MCPaintballEntities.GREEN_PAINTBALL, owner, world, ItemStack.EMPTY);
    }
