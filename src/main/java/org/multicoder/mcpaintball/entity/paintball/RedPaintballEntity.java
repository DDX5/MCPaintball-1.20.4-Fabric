...
public class RedPaintballEntity extends PersistentProjectileEntity
{


    public RedPaintballEntity(EntityType<? extends PersistentProjectileEntity> type, World world)
    {
        super(type, world, ItemStack.EMPTY);
    }

    public RedPaintballEntity(LivingEntity owner, World world)
    {
        super(MCPaintballEntities.RED_PAINTBALL, owner, world, ItemStack.EMPTY);
    }
    @Override
