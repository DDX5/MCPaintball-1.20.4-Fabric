...
public class BluePaintballEntity extends PersistentProjectileEntity
{


    public BluePaintballEntity(EntityType<? extends PersistentProjectileEntity> type, World world)
    {
        super(type, world, ItemStack.EMPTY);
    }

    public BluePaintballEntity(LivingEntity owner, World world)
    {
        super(MCPaintballEntities.BLUE_PAINTBALL, owner, world, ItemStack.EMPTY);
    }
