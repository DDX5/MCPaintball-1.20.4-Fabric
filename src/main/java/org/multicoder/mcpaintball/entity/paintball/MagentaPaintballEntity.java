...
public class MagentaPaintballEntity extends PersistentProjectileEntity
{


    public MagentaPaintballEntity(EntityType<? extends PersistentProjectileEntity> type, World world)
    {
        super(type, world, ItemStack.EMPTY);
    }

    public MagentaPaintballEntity(LivingEntity owner, World world)
    {
        super(MCPaintballEntities.MAGENTA_PAINTBALL, owner, world, ItemStack.EMPTY);
    }
    @Override
