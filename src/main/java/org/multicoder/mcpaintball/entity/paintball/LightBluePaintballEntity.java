...
public class LightBluePaintballEntity extends PersistentProjectileEntity
{


    public LightBluePaintballEntity(EntityType<? extends PersistentProjectileEntity> type, World world)
    {
        super(type, world, ItemStack.EMPTY);
    }

    public LightBluePaintballEntity(LivingEntity owner, World world)
    {
        super(MCPaintballEntities.LIGHT_BLUE_PAINTBALL, owner, world, ItemStack.EMPTY);
    }
    @Override
