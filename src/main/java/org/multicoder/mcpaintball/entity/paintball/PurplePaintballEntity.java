...
public class PurplePaintballEntity extends PersistentProjectileEntity
{


    public PurplePaintballEntity(EntityType<? extends PersistentProjectileEntity> type, World world)
    {
        super(type, world, ItemStack.EMPTY);
    }

    public PurplePaintballEntity(LivingEntity owner, World world)
    {
        super(MCPaintballEntities.PURPLE_PAINTBALL, owner, world, ItemStack.EMPTY);
    }
    @Override
