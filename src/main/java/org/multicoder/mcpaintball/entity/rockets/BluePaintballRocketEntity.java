...
public class BluePaintballRocketEntity extends PersistentProjectileEntity
{

    public BluePaintballRocketEntity(EntityType<? extends PersistentProjectileEntity> type, World world)
    {
        super(type, world, ItemStack.EMPTY);
    }

    public BluePaintballRocketEntity(LivingEntity owner, World world)
    {
        super(MCPaintballEntities.BLUE_PAINTBALL_ROCKET, owner, world, ItemStack.EMPTY);
    }
