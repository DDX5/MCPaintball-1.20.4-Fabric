...
public class GreenPaintballRocketEntity extends PersistentProjectileEntity {

    public GreenPaintballRocketEntity(EntityType<? extends PersistentProjectileEntity> type, World world) {
        super(type, world, ItemStack.EMPTY);
    }

    public GreenPaintballRocketEntity(LivingEntity owner, World world) {
        super(MCPaintballEntities.GREEN_PAINTBALL_ROCKET, owner, world, ItemStack.EMPTY);
    }
