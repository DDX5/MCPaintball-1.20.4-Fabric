...
public class LightBluePaintballRocketEntity extends PersistentProjectileEntity {

    public LightBluePaintballRocketEntity(EntityType<? extends PersistentProjectileEntity> type, World world) {
        super(type, world, ItemStack.EMPTY);
    }

    public LightBluePaintballRocketEntity(LivingEntity owner, World world) {
        super(MCPaintballEntities.LIGHT_BLUE_PAINTBALL_ROCKET, owner, world, ItemStack.EMPTY);
    }
