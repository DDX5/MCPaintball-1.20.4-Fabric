...
public class PinkPaintballRocketEntity extends PersistentProjectileEntity
{

    public PinkPaintballRocketEntity(EntityType<? extends PersistentProjectileEntity> type, World world)
    {
        super(type, world, ItemStack.EMPTY);
    }

    public PinkPaintballRocketEntity(LivingEntity owner, World world)
    {
        super(MCPaintballEntities.PINK_PAINTBALL_ROCKET, owner, world, ItemStack.EMPTY);
    }
