...
public class LimePaintballRocketEntity extends PersistentProjectileEntity {

    public LimePaintballRocketEntity(EntityType<? extends PersistentProjectileEntity> type, World world) {
        super(type, world, ItemStack.EMPTY);
    }

    public LimePaintballRocketEntity(LivingEntity owner, World world) {
        super(MCPaintballEntities.LIME_PAINTBALL_ROCKET, owner, world, ItemStack.EMPTY);
    }
