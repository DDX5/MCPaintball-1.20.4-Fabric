...
public class CyanPaintballRocketEntity extends PersistentProjectileEntity
{

    public CyanPaintballRocketEntity(EntityType<? extends PersistentProjectileEntity> type, World world)
    {
        super(type, world, ItemStack.EMPTY);
    }

    public CyanPaintballRocketEntity(LivingEntity owner, World world)
    {
        super(MCPaintballEntities.CYAN_PAINTBALL_ROCKET, owner, world, ItemStack.EMPTY);
    }
