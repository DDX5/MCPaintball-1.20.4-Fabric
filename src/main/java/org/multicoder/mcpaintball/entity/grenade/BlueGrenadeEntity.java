...
public class BlueGrenadeEntity extends ThrownItemEntity {

    public BlueGrenadeEntity(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
    }


    public BlueGrenadeEntity(LivingEntity livingEntity, World world) {
        super(MCPaintballEntities.BLUE_GRENADE, livingEntity, world);
    }
    ...
    protected Item getDefaultItem() {
        return MCPaintballItems.BLUE_GRENADE;
    }


    @Override
    protected ItemStack getItem() {
        return new ItemStack(MCPaintballItems.BLUE_GRENADE);
    }
}
