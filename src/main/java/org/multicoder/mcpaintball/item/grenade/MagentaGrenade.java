...
import org.multicoder.mcpaintball.entity.grenade.MagentaGrenadeEntity;
import org.multicoder.mcpaintball.world.PaintballMatchData;

public class MagentaGrenade extends Item {
    public MagentaGrenade() {
        super(new Settings());
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        if (!world.isClient()) {
            ...
            if (data.IsEnabled) {
                ThrownItemEntity E = new MagentaGrenadeEntity(user, world);
