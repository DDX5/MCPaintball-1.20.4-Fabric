...
import org.multicoder.mcpaintball.entity.grenade.LightBlueGrenadeEntity;
import org.multicoder.mcpaintball.world.PaintballMatchData;

public class LightBlueGrenade extends Item {
    public LightBlueGrenade() {
        super(new Settings());
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        if (!world.isClient()) {
            ...
            if (data.IsEnabled) {
                ThrownItemEntity E = new LightBlueGrenadeEntity(user, world);
