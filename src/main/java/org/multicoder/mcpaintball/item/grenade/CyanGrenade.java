...
import org.multicoder.mcpaintball.entity.grenade.CyanGrenadeEntity;
import org.multicoder.mcpaintball.world.PaintballMatchData;

public class CyanGrenade extends Item
{
    public CyanGrenade()
    {
        super(new Settings());
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand)
    {
        if(!world.isClient()) {
            ...
            if (data.IsEnabled) {
                ThrownItemEntity E = new CyanGrenadeEntity(user,world);
